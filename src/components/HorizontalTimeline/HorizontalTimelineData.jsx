...
const HorizontalTimelineData = ({ horizontalTimelineData = data }) => {
	const styleSet = {
		validationBlock: {
	...
	const opportunityTimelineDetails = horizontalTimelineData;
...
export default HorizontalTimelineData;
