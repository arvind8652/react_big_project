...
import ColorWithLabel from '../../components/LabelTypes/ColorWithLabel';
import LabelWithHelpText from '../../components/LabelTypes/LabelWithHelpText';
			...
			<GenericCard header={'Risk Profile'}>
							...
							{/* <Col style={styleSet.smeeter} >
              {
                ...
                />}
							...
							<Col span={8}>
								<div style={styleSet.cardText}>
									<LabelWithHelpText
										label={
											riskProfileData &&
											riskProfileData.nonRecommendedCategoryName &&
											riskProfileData.nonRecommendedCategoryName
										}
									...
									/>
									{riskProfileData?.isBlanketwaiver !== null ? (
										<LabelWithHelpText
											label={riskProfileData?.isBlanketwaiver === 'Y' ? 'Yes' : 'No'}
											helpText={'Blanket Waiver Received'}
										/>
									) : (
										''
									)}
						...
						{riskProfileData?.sophisticatedYn === 'Y' ? (
							<p style={styleSet.textBody}>
