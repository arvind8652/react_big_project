...
const OpportunityAttachmentDetails = (props) => {
	...
	return (
		<>
			...
			>
              ...
              pagination={false}
            /> */}
					<AttachmentListTable opportunityId={props.opportunityId} dataSource={dataSource} />
				</Content>
			</Card>
	...
	function handleUploadAttachments() {
		uploadAttachmentApi(attachments).then((res) => {
			...
			setUploadAttachmentSuccessFailureyMessage(
				res.data === true ? 'Uploaded Successfull' : 'Upload Failed'
			);
...
export default OpportunityAttachmentDetails;
