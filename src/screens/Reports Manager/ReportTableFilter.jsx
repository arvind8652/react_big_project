...
import { faFilter, faArchive, faTrashAlt, faArrowAltToBottom, faSyncAlt } from "@fortawesome/pro-solid-svg-icons";
    ...
    return (
      <>
        <div className="filters-panel">
          ...
          <div className="left">
            <FontAwesomeIcon className={selectedRowKeys.length === 0 ? "disabled-icon" : "icon"} icon={faArrowAltToBottom} style={{ marginRight: "15px" }} onClick={() => selectedRowKeys.length > 0 && downloadSelectedHandler()} />
            <FontAwesomeIcon
              icon={faTrashAlt}
            ...
            />
            <FontAwesomeIcon className={"icon"} icon={faSyncAlt} onClick={listRefreshHandler} />
