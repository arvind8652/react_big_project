...
import { executeAllTicketSupportListingDataApi } from '../../../redux/actions/ticketSupportListingActions';
...
const TicketSupportListing = () => {
	...
	const listingData = useSelector((state) => state?.ticketSupportReducer?.listingData);

	useEffect(() => {
		executeAllTicketSupportListingDataApi();
	}, []);
	useEffect(() => {
	...
	return (
		<div>
			...
			<TopBarHeader
				...
				navigationLink={'/dashboard/TicketSupport/TicketSupportCreateScreen'}
			/>
