...
const TaskListingCard = ({
	...
	/// Edit Interaction
	const handleEditTaskClick = (record, activityID, val) => {
		const toObject = {
					...
					<div key={index} className='row-action-option'>
						<span
							onClick={() => {
								...
								option.toLowerCase() === 'edit' &&
									id.record.occurrence === 1 &&
									handleEditTaskClick(id, record, 2);
...
export default connect(null, mapDispatchToProps)(TaskListingCard);
