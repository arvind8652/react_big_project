...
export const getLeadCreationCsApi = () => {
	return Api.get(apiRequestUrls.getLeadCreationCs);
};

export const postLeadApi = (payload) => {
	return Api.post(apiRequestUrls.postLead, payload);
};

export const postCompLeadApi = (formData, overwrite) => {
	const postObject = {
		data: {
			Lead: {
				Id: null,
				...
				Salutation: formData.leadType === 'I' ? formData.individualSalutation : null,
				FirstName:
					formData.leadType === 'I' ? formData.individualFirstName : formData.corporateCompanyName,
				MiddleName:
					formData.leadType === 'I'
				...
				Category:
					formData.leadType === 'I' ? formData.individualCategory : formData.corporateCategory,
				Nationality:
					formData.leadType === 'I'
						? formData.individualNationality
						: formData.corporateNationality,
				Gender: formData.leadType === 'I' ? formData.individualGender : null,
				Mobile: formData.contact || null,

				AlternateNumber: formData.alternateContact || null,
				...
				SocialList: [
					...
					},
					{
						...
						SocialMediaValue: formData.SocialType === 'Skype' ? formData.Mobile : '',
				...
				ReferenceName: null,
				DialCode: formData.countryCode || null,
				AlternateDialCode: formData.altCountryCode || null
			},
			// Misc: {
			//   Miscellaneous: [
			//     {
			...
			Attachment:
				formData.profileImageAttachment && formData.profileImageAttachment !== null
					? [formData.profileImageAttachment]
					: undefined,
			isOverwrite: overwrite ? true : formData.isOverwrite ? true : false
		}
	};
	return Api.post(apiRequestUrls.postLead, postObject);
};
